...
$locs = array("", "al", "ann", "atl", "aus", "bal", "bklyn", "bna", "bos", "buf", "ca", "chs", "chi", "cin", "cle", "col", "ct", "dal", "dca", "de", "den", "det", "fdk", "fl", "hou", "ky", "las", "lax", "lou", "md", "mem", "mi", "mia", "ms", "msy", "nc", "nj", "nocal", "nyc","nva", "oak", "ocnj", "pa", "phl","pdx", "phx", "rdu", "roc", "san", "sc", "sea", "sfo", "socal", "stl", "syr", "tn", "wa", "wi");
...
<div id="wrap">
	...
	<?php } else { ?>
		<h2><?php echo $city; ?></h2>
		<p id="not-eaten">All the restaurants with the text "<strong>Not eaten here yet.</strong>" at the end of the note are places I would like to visit that friends, blog posts, articles, TV shows, etc. recommend I eat.</p>
