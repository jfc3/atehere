...
<div id="wrap">
	...
	<?php } else { ?>
		<h2><?php echo $city; ?></h2>
		<p id="not-eaten">All the restaurants with an asterisk (<strong>
		</strong>) next to them are places I would like to visit that friends, blog posts, articles, TV shows, etc. recommend I eat.</p>
