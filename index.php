...
$locs = array("", "al", "ann", "ar", "atl", "aus", "avl", "az", "bal", "bhm", "bklyn", "bldr", "bli", "bna", "bos", "buf", "ca", "cak", "cha", "chi", "chs", "cin", "cle", "co", "col", "clt", "ct", "dal", "dca", "de", "den", "det", "fdk", "fl", "ga", "gsp", "hou", "il", "ilm", "in", "jan", "ky", "las", "lax", "lit", "lou", "md", "me", "mem", "mi", "mia", "ms", "msp", "msy", "nc", "nj", "nocal", "nyc", "ny", "nva", "oak", "ocnj", "oh", "oma", "or", "pa", "phl","pdx", "phx", "rdu", "ric", "roc", "san", "sat", "sav", "sc", "sea", "sfo", "socal", "stl", "syr", "tn", "tus", "tx", "tys", "ut", "va", "vt", "wa", "wi");
...
<head>
	...
	<style>
		...
		select { width: 100%; margin: 0 .5em 0 0; color: #000;}
		input[type="submit"] { font-size: 1em; font-weight: bold; padding: .5em; color: #000; background: #BEFF9E; margin: .75em 0 .25em 0;}
...
<div id="wrap">
	<div id="hdr" role="banner">
		<h1><a href="index.php" rel="me">jfciii Ate Here</a></h1>
	</div>
	...
	?>
			<li>
				...
				<?php if ($post->url != "" && $post->url != "hhh") { ;?>
					<h3 class="fn" id="<?php echo $rest_name; ?>" tabindex="-1"><a href="<?php echo $post->url; ?>" class="url"><?php echo $post->name; ?><?php if ($post->eaten != "yes" && $post->eaten != "jjj") { echo ' <span aria-labelledby="lfteh">*</span>';} ?></a></h3>
				<?php } else { ?>
