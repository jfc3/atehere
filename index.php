...
$locs = array("", "ann", "atl", "aus", "bal", "bklyn", "bna", "bos", "buf", "ca", "chi", "cle", "col", "de", "fl", "ky", "las", "lax", "md", "mem", "ms", "msy", "nc", "nj", "nocal", "nyc","nva", "oak", "ocnj", "pa", "phl","pdx", "roc", "san", "sea", "sfo", "syr", "dca");
	...
	<div id="cntnt" role="main">
		...
		<form name="RequestForm" method="get" action="index.php">
			...
			<select id="slct" name="slct">
				...
				<option value="syr">Seattle, WA</option>
