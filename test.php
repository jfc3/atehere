...
$locs = array("", "test", "al", "ann", "ar", "atl", "aus", "avl", "az", "bal", "bhm", "bklyn", "bldr", "bli", "bna", "bos", "buf", "ca", "cak", "cha", "chi", "chs", "cin", "cle", "co", "col", "clt", "ct", "dal", "dca", "de", "den", "det", "fdk", "fl", "ga", "gsp", "hou", "il", "ilm", "in", "jan", "ky", "las", "lax", "lit", "lou", "md", "me", "mem", "mi", "mia", "ms", "msp", "msy", "nc", "nj", "nocal", "ny", "nyc","nva", "oak", "ocnj", "oh", "oma", "or", "pa", "phl","pdx", "phx", "rdu", "ric", "roc", "san", "sat", "sav", "sc", "sea", "sfo", "socal", "stl", "syr", "tn", "tus", "tx", "tys", "ut", "va", "vt", "wa", "wi");
...
<div id="wrap">
	...
	<div id="cntnt" role="main">
		...
		?>
		<form name="RequestForm" method="get" action="test.php">
	...
	?>
			<li>
				    ...
				    <?php } ?>
						...
						<?php if ($post->eaten != "yes" && $post->eaten != "jjj") { ?>
							<p class="not-eaten">Looking forward to eating here.</p>
						<?php	}	?>
